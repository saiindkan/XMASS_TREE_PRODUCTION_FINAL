-- Simple password_resets table check - Fixed for column ambiguity
...
-- 9. Check if reset_token column exists
SELECT '=== CHECKING FOR RESET_TOKEN COLUMN ===' as info;
SELECT 
    CASE 
        WHEN EXISTS (
        ...
        ELSE 'reset_token column MISSING - This is likely the problem!'
...
SELECT 'Pay special attention to whether reset_token column exists.' as focus;
